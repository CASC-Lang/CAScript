	...
	public lex(): Token[] {
		...
		while (this.pos < this.source.length) {
			switch (this.source[this.pos]) {
				...
				case "?":
					tokens.push(
						new Token(TokenType.QuestionMark, this.pos, this.next())
					);
					break;
				case ":":
					tokens.push(
				...
				case "!":
					if (this.peek(1) === "=") {
						...
						tokens.push(
							new Token(TokenType.Bang, this.pos, this.next())
						);
					}
					break;
				case ">":
				...
				case "<":
					if (this.peek(1) === "<") {
						...
						tokens.push(
							new Token(TokenType.LessThan, this.pos, this.next())
						);
					}
					break;
				case "&":
				...
				case "^":
					tokens.push(
						new Token(TokenType.Caret, this.pos, this.next())
					);
					break;
				case "|":
					if (this.peek(1) === "|") {
						...
						tokens.push(
							new Token(TokenType.Pipe, this.pos, this.next())
						);
					}
					break;
				case "~":
					tokens.push(
						new Token(TokenType.Tilde, this.pos, this.next())
					);
					break;
				case "+":
					tokens.push(
						new Token(TokenType.Plus, this.pos, this.next())
					);
					break;
				case "-":
					tokens.push(
						new Token(TokenType.Minus, this.pos, this.next())
					);
					break;
				case "*":
					if (this.peek(1) === "*") {
						...
						tokens.push(
							new Token(TokenType.Star, this.pos, this.next())
						);
					}
					break;
				case "/":
					if (this.peek(1) === "/") {
						...
						tokens.push(
							new Token(TokenType.Slash, this.pos, this.next())
						);
					}
					break;
				case "%":
					tokens.push(
						new Token(TokenType.Percent, this.pos, this.next())
					);
					break;
				case " ":
				case "\t":
